<template>
  <header>
    <h1>My Friends contact</h1>
  </header>

  <main>
    <FormFriend :createFriend="createFriend" />
  </main>
</template>

<script>
import FormFriend from "./components/FormFriend.vue";
...
methodes:{
  createFriend(image, name, phone, email, adresse) {
    const newFriend = {
      image,
      name,
      phone,
